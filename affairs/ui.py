...
class Ui_Affairs(object):
    def setupUi(self, Affairs):
        ...
        self.sListWidget_2 = QtWidgets.QListWidget(self.centralwidget)
        self.sListWidget_2.setGeometry(QtCore.QRect(10, 420, 256, 141))
        self.sListWidget_2.setObjectName("sListWidget_2")
        self.tListWidget = QtWidgets.QListWidget(self.centralwidget)
        self.tListWidget.setGeometry(QtCore.QRect(520, 260, 256, 141))
